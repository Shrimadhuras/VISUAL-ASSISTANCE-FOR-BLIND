...
os.environ["PATH"] += os.pathsep + r"C:\Users\praga\Desktop\Blind\ffmpeg\bin"  # Replace with the actual path to ffmpeg
...
def tts(text,):
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".wav", dir=r"C:\Users\praga\Desktop\Blind") as tmp_file:
